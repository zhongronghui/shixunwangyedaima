    ...
    <div class="main-wrap">
        ...
        <div class="search-wrap">
            <div class="search-content">
                <form action="${pageContext.request.contextPath}/FindoneServlet.do?type=findnew" method="post" >
                    <table class="search-tab">
                        <tr>
                            <th width="70">请输入：</th>
                            <td><input class="common-text" placeholder="姓名" name="user_name"  onkeyup="this.value=this.value.replace(/\s+/g,'') " type="text"></td>
            ...
            <div class="result-content">
                <table class="result-tab" width="100%" >
                    ...
                    <tr align="center">
                        ...
                        <td><textarea rows="5" cols="10" readonly ><%= client.getUser_evaluate()%></textarea></td>
