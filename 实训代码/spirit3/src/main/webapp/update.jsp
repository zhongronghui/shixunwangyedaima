    ...
    <div class="main-wrap">
        ...
        <div class="result-wrap">
            <div class="result-content">
                <form action="${pageContext.request.contextPath}/UpdateServlet.do?type=changeall" method="post"  >
                    <table class="insert-tab" width="100%">
                        ...
                        <tr>
                            ...
                            <td>
                                <input class="common-text required"  name="user_name" size="50"  value="<%= client.getUser_name()%>" type="text"onkeyup="this.value=this.value.replace(/\s+/g,'')">
                            </td>
                        </tr>
                        <tr>
                            <th><i class="require-red">*</i>密码</th>
                            <td>
                                <input class="common-text required"  name="user_password" size="50" value="<%= client.getUser_password()%>"  type="text" onkeyup="this.value=this.value.replace(/\s+/g,'')">
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td><input type="date" name="user_birthday" value="<%= client.getUser_birthday()%>" ></td>
                        </tr>
                        <tr>
                            <th><i class="require-red">*</i>手机号</th>
                            <td><input type="text" name="user_number" value="<%= client.getUser_number()%>"  onkeyup="this.value=this.value.replace(/\s+/g,'')"></td>
                        </tr>
                        <tr>
                            <th><i class="require-red">*</i>入职时间</th>
                            <td><input type="date" name="user_jointime"  value="<%= client.getUser_jointime()%>" ></td>
                        </tr>
                        <tr>
                            <th><i class="require-red">*</i>职位</th>
                            <td><input type="text" name="user_position" value="<%= client.getUser_position()%>"onkeyup="this.value=this.value.replace(/\s+/g,'')" ></td>
                        </tr>
                        <tr>
                            <th><i class="require-red">*</i>薪水</th>
                            <td><input type="text" name="user_salary" value="<%= client.getUser_salary()%>" onkeyup="this.value=this.value.replace(/\s+/g,'')"></td>
                        </tr>
                        <tr>
